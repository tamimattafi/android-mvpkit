package com.tamimattafi.mvp.presentation.lists.adapters.recycler
...
abstract class RecyclerAdapter<H : IHolder>(private val view: IListenerView<H>) :
    RecyclerView.Adapter<ViewHolder>(), IAdapter {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
        when (viewType) {
            ...
            else -> throw IllegalArgumentException("$VIEW_TYPE_ERROR: $viewType")
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        (holder as? IListenerHolder)?.apply {
